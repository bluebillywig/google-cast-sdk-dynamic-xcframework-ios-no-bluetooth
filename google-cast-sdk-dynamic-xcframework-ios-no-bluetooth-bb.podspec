Pod::Spec.new do |s|
    s.name = 'google-cast-sdk-dynamic-xcframework-ios-no-bluetooth-bb'
    s.version = '4.8.0'
    s.license = {
      type: 'Commercial',
    ...
    s.summary = 'Framework for casting content to Google Cast devices with no Bluetooth requirements (dynamically-linked version as xcframework)'
    ...
    s.source = {
      http: 'https://dl.google.com/dl/chromecast/sdk/ios/GoogleCastSDK-ios-no-bluetooth-4.8.0_dynamic_xcframework.zip'
    }
    s.platform = :ios, '13.0'
